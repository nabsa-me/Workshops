...
export class ApplicationStack extends Stack {
  constructor(scope: App, id: string, props: StackProps) {
    ...
    new appconfig.Application(this, 'gooDo-Application', {
      applicationName: 'gooDo',
      description: 'application for the gooDo project resources management'
    })

    new appconfig.Application(this, 'workshops-Application', {
      applicationName: 'workshops',
      description: 'application for the gooDo project resources management'
    })
