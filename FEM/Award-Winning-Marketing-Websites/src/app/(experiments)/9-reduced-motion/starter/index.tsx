    ...
    <div ref={containerRef} className="motion-safe:h-[400vh]">
      ...
      <div className="relative w-full overflow-clip">
        <section className="title h-screen fixed w-full motion-reduce:relative">
          <NextImage src={heroImage} className="absolute inset-0 h-full object-cover motion-safe:hidden" alt="Perseverance rover"/>
        ...
        <section className="cameras fixed h-screen w-full top-0 left-0 motion-safe:opacity-0 motion-reduce:relative">
          <NextImage src={cameraImage} className="absolute inset-0 h-full object-cover motion-safe:hidden" alt="Perseverance rover"/>
        ...
        <section className="wheels fixed h-screen w-full motion-safe:opacity-0 motion-reduce:relative">
          <NextImage src={wheelsImage} className="absolute inset-0 h-full object-cover motion-safe:hidden" alt="Perseverance rover"/>
